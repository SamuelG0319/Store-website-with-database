...
--
-- Host: localhost:3306
-- Generation Time: Oct 23, 2023 at 08:50 PM
...
(8, 'Sydney', '+61 64457845', 'P.sherman calle wallaby 42 ', 'Between shopping center and 23rd street', 'SY', 'Australia', 'NSW 2024', 'APAC');
...
('Trains', 'Model trains are a rewarding hobby for enthusiasts of all ages. Whether you\re looking for collectible wooden trains, electric streetcars or locomotives, youll find a number of great choices for any budget within this category. The interactive aspect of trains makes toy trains perfect for young children. The wooden train sets are ideal for children under the age of 5.', NULL, NULL),
...
INSERT INTO `user` (`codusuario`, `usuario`, `contrasena`, `nombre`, `apellido`) VALUES
(1, 'samuel', 'samuel123', 'Samuel', 'Lasso'),
(2, 'miguelR', 'miguel123', 'Miguel', 'Rodriguez'),
(3, 'keily', 'keily123', 'Keily', 'Marin');
...
--
ALTER TABLE `offices`
  MODIFY `officeCode` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `codusuario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `employees`
  ...
  ADD CONSTRAINT `employees_ibfk_2` FOREIGN KEY (`officeCode`) REFERENCES `offices` (`officeCode`) ON DELETE RESTRICT ON UPDATE RESTRICT;
